...
const OrderList = () => {
  ...
  return (
    <div className="no-scrollbar mt-4 h-full overflow-x-auto rounded-md border print:hidden">
        ...
        <Table className="h-full border-collapse overflow-hidden rounded-lg border-gray-200 dark:border-gray-700">
          <TableHeader className="bg-background sticky top-0">
            <TableRow className="border-b border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
              <TableHead className="px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.id')}</TableHead>
              <TableHead className="px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.total')}</TableHead>
              <TableHead className="px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.status')}</TableHead>
              <TableHead className="px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.items')}</TableHead>
              <TableHead className="px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.created')}</TableHead>
              <TableHead className="flex items-center justify-center px-2 md:px-6 text-sm font-bold text-gray-700 dark:text-gray-300">{t('components.admin-ui.order.order-list.table.header.actions')}</TableHead>
            </TableRow>
          </TableHeader>
            ...
            {!loading &&
              ...
              orders.map((order) => (
                <TableRow key={order.id} className="border-b border-gray-200 hover:bg-gray-50 dark:border-gray-700 dark:hover:bg-gray-800">
                  <TableCell className="text-muted-foreground px-2 md:px-6 text-sm font-normal">
                    <TooltipProvider>
                      <Tooltip>
                        <TooltipTrigger>
